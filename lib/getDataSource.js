    ...
    return (0, _metalsmithPrismic.default)({
      ...
      linkResolver: configLinkResolver || function (ctx, doc) {
        ...
        if (_lodash.default.has(doc, 'data.slug.json.value')) {
          var regExpDomain = new RegExp(".*".concat(opts.config.domainSettings.domainLive)); // Strip domain (+ everything before it) off of the slug in case it was added by mistake
