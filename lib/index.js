...
var _markdown = _interopRequireDefault(require("@metalsmith/markdown"));
...
var MetalSmithLoader = function MetalSmithLoader(opts) {
  ...
  if (opts.dataSource && opts.dataSource.type === 'prismic') {
    metalSmith.use((0, _getPrismicContent.default)(opts));
  }
  metalSmith.use((0, _markdown.default)({
    parser: _markdownIt.default,
    parserOptions: {
      html: true,
      linkify: true,
      typography: true
    }
  })).use((0, _metalsmithReactTpl.default)({
    babel: true,
    noConflict: false,
    isStatic: isStatic,
    baseFile: 'layout.jsx',
...
var _default = exports.default = MetalSmithLoader;